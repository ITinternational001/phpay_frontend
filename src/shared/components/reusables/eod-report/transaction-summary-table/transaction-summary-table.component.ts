...
@Component({
  selector: 'app-transaction-summary-table',
  templateUrl: './transaction-summary-table.component.html',
  styleUrls: ['./transaction-summary-table.component.scss']
})
export class TransactionSummaryTableComponent implements OnInit, OnDestroy {
  ...
  ngOnChanges(changes: SimpleChanges): void {
    ...
    getTransactionSummary(startDate?: string, keywords?: string): void {
      ...
      this.observable = this.reportService.apiReportsGetEODTransactionCashinSummaryReportGet(new Date(dateToUse), keywords);
