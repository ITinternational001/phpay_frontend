...
export class VendorSummaryComponent implements OnInit {
  ...
  displayedColumns: string[] = ['CIvendor', 'CIchannel', 'CIgross', 'CIacFees', 'CIcount', 'CInet'];
  ...
  getVendorCashIn(startDate?: string, keyword?: string): void {
    ...
    this.observable = this.reportService.apiReportsGetEODVendorCashinSummaryReportGet(new Date(formattedStartDate), keyword);
