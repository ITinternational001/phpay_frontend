...
export const sidenavData: INavbarData[] = [
    ...
    {
        routeLink: 'dpayclients',
        icon: 'fal fa-solid fa-users',
        label: 'clients',
        items: [
            {
                routeLink: 'dpayclients/list',
                label: 'clientsList',
                name: Navigation.ClientList,
                page: '/admin/dpayclients/list',
                isMaintenance: false,
            },
            {
                routeLink: 'dpayclients/cashoutfunds',
                label: 'availableBalance',
                page: '/admin/dpayclients/cashoutfunds',
                name: Navigation.COFunds,
                isMaintenance: false,
            },

            {
                routeLink:'dpayclients/transfers',
                label: 'transferBalance',
                page: '/admin/dpayclients/transfers',
                name: Navigation.BalanceTransfer,
                isMaintenance: false,
            },
            {
                routeLink:'dpayclients/remittances',
                label: 'remitanceclient',
                page: '/admin/dpayclients/remittances',
